/*
 ...
 Source Schema         : oauth_two

 Target Server Type    : MySQL
 Target Server Version : 80019
 File Encoding         : 65001

 Date: 15/02/2022 02:44:27
*/
...
CREATE TABLE `credentials`  (
  ...
  `password` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '这里的数据为加密后的 ”user“',
...
CREATE TABLE `oauth_client_details`  (
  ...
  `client_secret` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '密钥是123',
  `scope` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
